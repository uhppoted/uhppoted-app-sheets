...
debug: build
	$(CLI) help
	$(CLI) help load-acl
	$(CLI) load-acl --dryrun --config ../runtime/sheets/uhppoted.conf --credentials $(CREDENTIALS) --url "https://docs.google.com/spreadsheets/d/1iSZzHlrXsl3-mipIq0uuEqDNlPWGdamSPJrPe9OBD0k" --range "ACL!A2:K" --log "Log!A1:G"
...
load-acl: build
	$(CLI) load-acl --credentials $(CREDENTIALS) --url "https://docs.google.com/spreadsheets/d/1iSZzHlrXsl3-mipIq0uuEqDNlPWGdamSPJrPe9OBD0k" --range "ACL!A:K" --log "Log!A1:G"
